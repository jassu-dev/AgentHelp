                      ...
                      <li key={assignment.id} className="bg-secondary p-4 rounded-lg border border-border-color hover:border-accent transition-all group hover:shadow-sm">
                        <div className="flex justify-between items-center">
                          ...
                          <button
                            ...
                            className="bg-accent text-white font-bold py-2 px-4 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity transform group-hover:scale-100 scale-95"
                          >
                            Solve
                          </button>
                        </div>
